...
import com.rozolin.hellocucumber.Banco;
...
public class BancoTestePassos {
       ...
       public void o_total_de_contas_e(int totalContasEsperado) throws Throwable {
             Assert.assertEquals("O cálculo do total de contas está incorreto",
       ...
       public void o_total_de_dinheiro_no_banco_e(Double totalDinheiroEsperado) 
         throws Throwable {
             ...
             Assert.assertEquals("O cálculo do total de dinheiro no banco " + banco.getNome()
              + " está incorreto",
